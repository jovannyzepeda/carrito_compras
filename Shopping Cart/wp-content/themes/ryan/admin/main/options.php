...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_upgrade(
			...
			array(
				...
				'priority'     => 1,
				'upgrade_text' => __( 'Upgrade Now', 'ryan' ),
				'upgrade_url'  => '//www.thinkupthemes.com/themes/ryan/',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => 'thinkup_customizer_section_homepage',
			'type'			  => 'dropdown-pages',
			'description'	  => __( 'Slide 1 - Content (image, title, except, url)', 'ryan' ),
			'active_callback' => 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => 'thinkup_customizer_section_homepage',
			'type'			  => 'dropdown-pages',
			'description'	  => __( 'Slide 2 - Content (image, title, except, url)', 'ryan' ),
			'active_callback' => 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => 'thinkup_customizer_section_homepage',
			'type'			  => 'dropdown-pages',
			'description'	  => __( 'Slide 3 - Content (image, title, except, url)', 'ryan' ),
			'active_callback' => 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade(
			...
			array(
				...
				'title_main'	  => __( 'So... Why upgrade?', 'ryan' ),
				'title_secondary' => __( 'We&#39;re glad you asked! Here&#39;s just some of the amazing features you&#39;ll get when you upgrade...', 'ryan' ),
				'images'		  => array(
